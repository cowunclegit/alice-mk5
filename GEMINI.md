...
- Node.js (Latest LTS), JavaScript (ESM) + LangGraph.js, Robot Framework (Browser Library), Playwright (AX API) (002-agent-workflow-optimization)
- Local file system (for session logs and snapshots) (002-agent-workflow-optimization)
...
## Recent Changes
- 002-agent-workflow-optimization: Added Node.js (Latest LTS), JavaScript (ESM) + LangGraph.js, Robot Framework (Browser Library), Playwright (AX API)
